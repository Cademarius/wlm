...
const Header = ({ lang }: HeaderProps) => {
  ...
  const NAV_LINKS = [
    {
      id: "mon-fil",
      label: t.header.navigation.myFeed,
      href: `/${lang}/feed`,
      icon: Home,
    },
    {
      id: "mes-crushs",
      label: t.header.navigation.myCrushes,
      href: `/${lang}/addcrush`,
      icon: HeartTick,
    },
    {
      id: "qui-ma-crush",
      label: t.header.navigation.myAdmirers,
      href: `/${lang}/matchcrush`,
      icon: ProfileCircle,
    },
    {
    id: "mon-profile",
        ...
        {isSearchActive ? (
          ...
          <>
            ...
            <button
              ...
              className="p-1 cursor-pointer text-white hover:text-[#FF4F81] transition-colors duration-200"
              aria-label={
                isMobileMenuOpen ? t.header.menu.close : t.header.menu.open
              }
            >
              {isMobileMenuOpen ? (
